...
<body>
	<div class="container">
		...
		<form action="include/function.php" method="post" id="login-form" enctype="multipart/form-data">
			<!-- javascript:void(0) -->
			<div><span id="error"></span> </div>
			<input type="hidden" id="action" value="login">
			<label for="fname">Username / Identity Number</label>
			<input type="text" name="username" id="idno" placeholder="Enter your ID NO" required>
	...
	<script type="text/javascript" src="../assets/javascript/validate.js"></script>
