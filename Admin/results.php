...
require_once 'include/slugify.php';
		...
		<div class="main">
			<div class="index">
				...
				<div class="scrolmenu" style="display: none;" id="governorDiv">
					...
					<div class="can-list">
						<?php
						$sql=mysqli_query($conn,"SELECT Name, id_table.IdentityNo, Profile, Political_Party FROM candidate, governor, id_table WHERE candidate.IdentityNo=id_table.IdentityNo  and candidate.IdentityNo=governor.IdentityNo");
					...
					<center>
						<div style="width: 90%; height: 100px; border: 1px solid; border-radius: 5px; padding: 10px;" id="results">
							...
							$sql = "SELECT Name, count(Governor) as voteCount from votes, location, id_table, governor where governor.IdentityNo=id_table.IdentityNo and votes.Governor=Governor.IdentityNo";
							$result = mysqli_query($conn, $sql);
				...
				<div class="scrolmenu" style="display: none;" id="womenDiv">
					...
					<center>
						<div style="width: 90%; height: 100px; border: 1px solid; border-radius: 5px; padding: 10px;" id="results">
							...
							$sql = "SELECT Name, count(Women_Rep) as voteCount from votes, id_table, Women_Rep where Women_Rep.IdentityNo=id_table.IdentityNo and votes.Women_Rep=Women_Rep.IdentityNo";
							$result = mysqli_query($conn, $sql);
				...
				<div class="scrolmenu" style="display: none;" id="senatorDiv">
					...
					<center>
						<div style="width: 90%; height: 100px; border: 1px solid; border-radius: 5px; padding: 10px;" id="results">
							...
							$sql = "SELECT Name, count(Senator) as voteCount from votes, id_table, Senator where Senator.IdentityNo=id_table.IdentityNo and votes.Senator=Senator.IdentityNo";
							$result = mysqli_query($conn, $sql);
				...
				<div class="scrolmenu" style="display: none;" id="mpDiv">
					...
					<center>
						<div style="width: 90%; height: 100px; border: 1px solid; border-radius: 5px; padding: 10px;" id="results">
							...
							$sql = "SELECT Name, count(MP) as voteCount from votes, id_table, mps where  mps.IdentityNo=id_table.IdentityNo and votes.MP=mps.IdentityNo";
							$result = mysqli_query($conn, $sql);
				...
				<div class="scrolmenu" style="display: none;" id="mcaDiv">
					...
					<center>
						<div style="width: 90%; height: 100px; border: 1px solid; border-radius: 5px; padding: 10px;" id="results">
							...
							$sql = "SELECT Name, count(MCA) as voteCount from votes, id_table, mcas where  mcas.IdentityNo=id_table.IdentityNo and votes.MCA=mcas.IdentityNo";
							$result = mysqli_query($conn, $sql);
